  ...
  var toHome = () => {
    ...
    return (
            ...
            <a href="/" className="logo-link" onClick={() => toHome()}>
              <span className="hide-content">Cours Masson</span>
                <div className="big-logo" aria-hidden="true">
                   <img className="small-logo" src="img/logo/ill-short-dark.svg" alt="Cours Masson logo" aria-hidden="true"/>
      ...
      C139.8,23.2,139.8,31.5,144.8,36.8L144.8,36.8z"/>
                           <path fill="currentColor" d="M217.4,48.1L200.2,6.3h9.8l11.4,28.3l11.3-28.3h9.8l-17.1,41.8H217.4z"/>
                           <path fill="currentColor" d="M271.6,48.1V6.3h28.6v8.4h-19.3v7.9h18.1v8.2h-18.1v8.9h19.7v8.4L271.6,48.1z"/>
                           <path fill="currentColor" d="M332.9,48.1V6.3h4.7v37.5h17.2v4.3L332.9,48.1z"/>
                           <path fill="currentColor" d="M382,48.1l17.7-41.8h3.6L421,48.1h-5l-4.3-10.3h-20.3L387,48.1H382z M393.2,33.5h16.7l-8.3-19.9L393.2,33.5z"/>
                           <path fill="currentColor" d="M452.6,48.1V6.3h4.3l16,26.5l16-26.5h4.3v41.8h-4.6V15.6l-15.6,25.6l-15.7-25.5v32.5H452.6z"/>
                           <path fill="currentColor" d="M528.2,48.1V6.3h13.4c3.4-0.1,6.7,1.2,9.1,3.7c2.5,2.4,3.8,5.7,3.7,9.1c0.1,3.4-1.3,6.7-3.7,9.1
      ...
      L210.7,33.6z"/>
                           <path fill="currentColor" d="M270.1,48.2V6.4h4.3l16,26.5l16-26.5h4.3v41.8H306V15.7l-15.6,25.6l-15.7-25.5v32.5H270.1z"/>
                           <path fill="currentColor" d="M345.7,48.2V6.4h13.4c3.5,0,6.6,1.2,9.1,3.7c2.5,2.4,3.7,5.4,3.7,9.1c0,3.7-1.3,6.7-3.7,9.1
      ...
      c-1.6-1.6-3.5-2.4-5.9-2.4h-8.5V27.5z"/>
                           <path fill="currentColor" d="M116.1,18.3c0,3.2-1.2,6.4-3.7,8.8l-21,21l-21-21c-4.9-4.9-4.9-12.8,0-17.7c2.4-2.4,5.6-3.7,8.9-3.7
